...
function addValues(_arr) {
  let newArr = _arr.reduce((a, b) => {
    return a + b;
  }, 0); return newArr;
}
...
const countNumberOfElements = (_arr) => {
  let newArr = _arr.reduce((a) => {
    a = a + 1;
    return a;
  }, 0);
  return newArr;
...
const reversedString = (_str) => {
  return _str.split('').reduce((a, b) => b + a, '');
};
...
const countNumberOfChildren = (_arr) => {
  // Solution code here...
};
...
const extractStat = (_statName, _arr) => {
  // Solution code here...
};
